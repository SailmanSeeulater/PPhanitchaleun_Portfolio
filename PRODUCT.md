...
- Features in place: 11 selectable color themes (persisted), clickable tech badges that list which repos use a skill, a SoundCloud music player (Widget API, Perfect's own tracks), GoatCounter analytics with a public visitor count (site code `latesailor`).
